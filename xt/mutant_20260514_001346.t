...
# --- SURVIVOR: NUM_BOUNDARY_1665_20_< (HIGH) line 1665 in risk_assessment() ---
...
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1665_20_< line 1665 in risk_assessment()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 1665 in risk_assessment() to detect the mutant
    fail('NUM_BOUNDARY_1665_20_<: replace with real assertion');
}
...
# --- SURVIVOR: COND_INV_4289_2 (MEDIUM) line 4289 in _debug() ---
# Source:  if($self->{verbose}) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4289_2 line 4289 in _debug()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4289 in _debug() to detect the mutant
    fail('COND_INV_4289_2: replace with real assertion');
}
