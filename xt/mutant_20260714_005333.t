...
# --- SURVIVOR: COND_INV_3904_2 (MEDIUM) line 3904 in _parse_domain_whois_abuse() ---
# Source:  # Security:
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_3904_2 line 3904 in _parse_domain_whois_abuse()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 3904 in _parse_domain_whois_abuse() to detect the mutant
...
# Source:  # Validate and normalise the IP before interpolating into the URL path.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Use the ARIN RDAP endpoint; it covers the ARIN region and redirects
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  my $res = eval { $ua->get("https://rdap.arin.net/registry/ip/$safe_ip") };
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  # Strip all C0/C1 control characters to prevent WHOIS protocol injection.
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (4 variants — one test should kill all):
#   Numeric boundary flip <= to <
#   Numeric boundary flip <= to >
...
# Source:  # the :Protected boundary so subclass callers are also protected.
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip <= to <
#   Numeric boundary flip <= to >
...
# Source:  $self->_debug("WHOIS $server -> $safe_query");
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: COND_INV_4034_3 (MEDIUM) line 4034 in _raw_whois() ---
# Source:  # Read until EOF (server closes) or timeout
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4034_3 line 4034 in _raw_whois()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4034 in _raw_whois() to detect the mutant
    fail('COND_INV_4034_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4044_3 (MEDIUM) line 4044 in _raw_whois() ---
# Source:  $response .= $buf;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4044_3 line 4044 in _raw_whois()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4044 in _raw_whois() to detect the mutant
    fail('COND_INV_4044_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4050_2 (MEDIUM) line 4050 in _raw_whois() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4050_2 line 4050 in _raw_whois()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4050 in _raw_whois() to detect the mutant
    fail('COND_INV_4050_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4053_2 (MEDIUM) line 4053 in _raw_whois() ---
# Source:  # Purpose:
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4053_2 line 4053 in _raw_whois()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
...
# --- SURVIVOR: BOOL_NEGATE_4056_2 (MEDIUM) line 4056 in _raw_whois() ---
# Source:  #
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4056_2 line 4056 in _raw_whois()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4056 in _raw_whois() to detect the mutant
    fail('BOOL_NEGATE_4056_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4079_2 (MEDIUM) line 4079 in _parse_whois_text() ---
# Source:  for my $pat (
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4079_2 line 4079 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4079 in _parse_whois_text() to detect the mutant
    fail('BOOL_NEGATE_4079_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4091_2 (MEDIUM) line 4091 in _parse_whois_text() ---
# Source:  # Country code (case-insensitive match, normalised to uppercase)
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4091_2 line 4091 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4091 in _parse_whois_text() to detect the mutant
    fail('COND_INV_4091_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4092_2 (MEDIUM) line 4092 in _parse_whois_text() ---
# Source:  if ($text =~ /^country:\s*([A-Za-z]{2})\s*$/m) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4092_2 line 4092 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4092 in _parse_whois_text() to detect the mutant
    fail('COND_INV_4092_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4093_2 (MEDIUM) line 4093 in _parse_whois_text() ---
# Source:  $info{country} = uc $1;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4093_2 line 4093 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4093 in _parse_whois_text() to detect the mutant
    fail('COND_INV_4093_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4094_2 (MEDIUM) line 4094 in _parse_whois_text() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4094_2 line 4094 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4094 in _parse_whois_text() to detect the mutant
    fail('COND_INV_4094_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4105_3 (MEDIUM) line 4105 in _parse_whois_text() ---
# Source:  #   Parse the Authentication-Results: header(s) from the message once,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4105_3 line 4105 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4105 in _parse_whois_text() to detect the mutant
    fail('COND_INV_4105_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4110_2 (MEDIUM) line 4110 in _parse_whois_text() ---
# Source:  #   $self->{_headers} populated by _split_message().
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4110_2 line 4110 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4110 in _parse_whois_text() to detect the mutant
    fail('COND_INV_4110_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4114_4 (MEDIUM) line 4114 in _parse_whois_text() ---
# Source:  #   Keys absent when the corresponding header or field is not present.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4114_4 line 4114 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4114 in _parse_whois_text() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_4148_3 (MEDIUM) line 4148 in _parse_auth_results_cached() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4148_3 line 4148 in _parse_auth_results_cached()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4148 in _parse_auth_results_cached() to detect the mutant
    fail('BOOL_NEGATE_4148_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4149_3 (MEDIUM) line 4149 in _parse_auth_results_cached() ---
# Source:  if (@dkim_domains) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4149_3 line 4149 in _parse_auth_results_cached()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4149 in _parse_auth_results_cached() to detect the mutant
    fail('BOOL_NEGATE_4149_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4170_2 (MEDIUM) line 4170 in _parse_auth_results_cached() ---
# Source:  # _provider_abuse_for_host( $host ) -> hashref | undef
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4170_2 line 4170 in _parse_auth_results_cached()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4170 in _parse_auth_results_cached() to detect the mutant
    fail('BOOL_NEGATE_4170_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4201_2 (MEDIUM) line 4201 in _provider_abuse_for_host() ---
# Source:  #   $ip   -- IPv4 or IPv6 address string (used as fallback if $rdns absent).
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4201_2 line 4201 in _provider_abuse_for_host()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
...
# --- SURVIVOR: BOOL_NEGATE_4204_3 (MEDIUM) line 4204 in _provider_abuse_for_host() ---
# Source:  # Exit status:
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4204_3 line 4204 in _provider_abuse_for_host()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4204 in _provider_abuse_for_host() to detect the mutant
    fail('BOOL_NEGATE_4204_3: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_4209_26_< (HIGH) line 4209 in _provider_abuse_for_ip() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_4209_26_< line 4209 in _provider_abuse_for_ip()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4209 in _provider_abuse_for_ip() to detect the mutant
    fail('NUM_BOUNDARY_4209_26_<: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4212_2 (MEDIUM) line 4212 in _provider_abuse_for_ip() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4212_2 line 4212 in _provider_abuse_for_ip()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4212 in _provider_abuse_for_ip() to detect the mutant
    fail('COND_INV_4212_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4214_3 (MEDIUM) line 4214 in _provider_abuse_for_ip() ---
# Source:  # Private: eTLD+1 normalisation
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4214_3 line 4214 in _provider_abuse_for_ip()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4214 in _provider_abuse_for_ip() to detect the mutant
    fail('BOOL_NEGATE_4214_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4216_2 (MEDIUM) line 4216 in _provider_abuse_for_ip() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4216_2 line 4216 in _provider_abuse_for_ip()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4216 in _provider_abuse_for_ip() to detect the mutant
    fail('BOOL_NEGATE_4216_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4328_2 (MEDIUM) line 4328 in _enrich_ip() ---
# Source:  =head3 Notes
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4328_2 line 4328 in _enrich_ip()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4328 in _enrich_ip() to detect the mutant
    fail('BOOL_NEGATE_4328_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4348_3 (MEDIUM) line 4348 in _enrich_ip() ---
# Source:  None -- returns C<undef> on a missing header, never throws.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4348_3 line 4348 in _enrich_ip()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4348 in _enrich_ip() to detect the mutant
    fail('BOOL_NEGATE_4348_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4368_2 (MEDIUM) line 4368 in header_value() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4368_2 line 4368 in header_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4368 in header_value() to detect the mutant
    fail('BOOL_NEGATE_4368_2: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_4370_65_< (HIGH) line 4370 in header_value() ---
# Source:  #
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (4 variants — one test should kill all):
#   Numeric boundary flip > to <
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_4370_65_< line 4370 in header_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4370 in header_value() to detect the mutant
    fail('NUM_BOUNDARY_4370_65_<: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_4376_25_!= (HIGH) line 4376 in header_value() ---
# Source:  #
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (2 variants — one test should kill all):
#   Numeric boundary flip == to !=
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_4376_25_!= line 4376 in header_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4376 in header_value() to detect the mutant
    fail('NUM_BOUNDARY_4376_25_!=: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4393_2 (MEDIUM) line 4393 in _header_value() ---
# Source:  #
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4393_2 line 4393 in _header_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4393 in _header_value() to detect the mutant
    fail('BOOL_NEGATE_4393_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4396_2 (MEDIUM) line 4396 in _header_value() ---
# Source:  #   match (when $cidr contains no '/' separator).
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4396_2 line 4396 in _header_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4396 in _header_value() to detect the mutant
    fail('BOOL_NEGATE_4396_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4411_2 (MEDIUM) line 4411 in _ip_in_cidr() ---
# Source:  # Compute the network mask and compare masked network addresses
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4411_2 line 4411 in _ip_in_cidr()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4411 in _ip_in_cidr() to detect the mutant
    fail('COND_INV_4411_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4418_2 (MEDIUM) line 4418 in _ip_in_cidr() ---
# Source:  # _decode_mime_words( $str ) -> decoded_string
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4418_2 line 4418 in _ip_in_cidr()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4418 in _ip_in_cidr() to detect the mutant
    fail('BOOL_NEGATE_4418_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4441_2 (MEDIUM) line 4441 in _decode_mime_words() ---
# Source:  #   Decode a single MIME encoded-word component (base64 or quoted-printable).
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4441_2 line 4441 in _decode_mime_words()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4441 in _decode_mime_words() to detect the mutant
    fail('COND_INV_4441_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4453_4 (MEDIUM) line 4453 in _decode_ew() ---
# Source:  # Quoted-printable encoded-word uses underscore for space
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4453_4 line 4453 in _decode_ew()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4453 in _decode_ew() to detect the mutant
    fail('BOOL_NEGATE_4453_4: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4455_3 (MEDIUM) line 4455 in _decode_ew() ---
# Source:  $raw  = decode_qp($text);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4455_3 line 4455 in _decode_ew()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4455 in _decode_ew() to detect the mutant
    fail('BOOL_NEGATE_4455_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4459_2 (MEDIUM) line 4459 in _decode_ew() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4459_2 line 4459 in _decode_ew()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4459 in _decode_ew() to detect the mutant
    fail('COND_INV_4459_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4465_2 (MEDIUM) line 4465 in _decode_ew() ---
# Source:  #
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4465_2 line 4465 in _decode_ew()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4465 in _decode_ew() to detect the mutant
    fail('COND_INV_4465_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4466_3 (MEDIUM) line 4466 in _decode_ew() ---
# Source:  # Entry criteria:
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4466_3 line 4466 in _decode_ew()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4466 in _decode_ew() to detect the mutant
    fail('BOOL_NEGATE_4466_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4469_2 (MEDIUM) line 4469 in _decode_ew() ---
# Source:  # Exit status:
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4469_2 line 4469 in _decode_ew()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4469 in _decode_ew() to detect the mutant
    fail('BOOL_NEGATE_4469_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4491_2 (MEDIUM) line 4491 in _parse_date_to_epoch() ---
# Source:  # We must subtract the local timezone offset to get the true UTC epoch.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4491_2 line 4491 in _parse_date_to_epoch()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4491 in _parse_date_to_epoch() to detect the mutant
    fail('COND_INV_4491_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4495_3 (MEDIUM) line 4495 in _parse_date_to_epoch() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4495_3 line 4495 in _parse_date_to_epoch()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4495 in _parse_date_to_epoch() to detect the mutant
    fail('COND_INV_4495_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4496_4 (MEDIUM) line 4496 in _parse_date_to_epoch() ---
# Source:  my ($y, $m, $d);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4496_4 line 4496 in _parse_date_to_epoch()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4496 in _parse_date_to_epoch() to detect the mutant
...
# --- SURVIVOR: COND_INV_4539_2 (MEDIUM) line 4539 in _parse_rfc2822_date() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4539_2 line 4539 in _parse_rfc2822_date()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4539 in _parse_rfc2822_date() to detect the mutant
    fail('COND_INV_4539_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4540_3 (MEDIUM) line 4540 in _parse_rfc2822_date() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_4540_3 line 4540 in _parse_rfc2822_date()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4540 in _parse_rfc2822_date() to detect the mutant
...
# --- LOW HINT: RETURN_UNDEF_4056_2 line 4056 in _raw_whois() ---
# Source:  #
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4079_2 line 4079 in _parse_whois_text() ---
# Source:  for my $pat (
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4148_3 line 4148 in _parse_auth_results_cached() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_4149_3 line 4149 in _parse_auth_results_cached() ---
# Source:  if (@dkim_domains) {
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4170_2 line 4170 in _parse_auth_results_cached() ---
# Source:  # _provider_abuse_for_host( $host ) -> hashref | undef
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4204_3 line 4204 in _provider_abuse_for_host() ---
# Source:  # Exit status:
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4209_2 line 4209 in _provider_abuse_for_ip() ---
# Source:  return $self->_provider_abuse_for_host($rdns) if $rdns;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4214_3 line 4214 in _provider_abuse_for_ip() ---
# Source:  # Private: eTLD+1 normalisation
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4216_2 line 4216 in _provider_abuse_for_ip() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_4328_2 line 4328 in _enrich_ip() ---
# Source:  =head3 Notes
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4348_3 line 4348 in _enrich_ip() ---
# Source:  None -- returns C<undef> on a missing header, never throws.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4368_2 line 4368 in header_value() ---
# Source:  }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4370_2 line 4370 in header_value() ---
# Source:  #
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4376_2 line 4376 in header_value() ---
# Source:  #
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4393_2 line 4393 in _header_value() ---
# Source:  #
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4396_2 line 4396 in _header_value() ---
# Source:  #   match (when $cidr contains no '/' separator).
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4418_2 line 4418 in _ip_in_cidr() ---
# Source:  # _decode_mime_words( $str ) -> decoded_string
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4453_4 line 4453 in _decode_ew() ---
# Source:  # Quoted-printable encoded-word uses underscore for space
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4455_3 line 4455 in _decode_ew() ---
# Source:  $raw  = decode_qp($text);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4466_3 line 4466 in _decode_ew() ---
# Source:  # Entry criteria:
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4469_2 line 4469 in _decode_ew() ---
# Source:  # Exit status:
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_4496_4 line 4496 in _parse_date_to_epoch() ---
# Source:  my ($y, $m, $d);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
