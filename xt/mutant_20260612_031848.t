...
# --- SURVIVOR: NUM_BOUNDARY_1632_38_> (HIGH) line 1632 in _risk_check_urls_and_domains() ---
...
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1632_38_> line 1632 in _risk_check_urls_and_domains()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 1632 in _risk_check_urls_and_domains() to detect the mutant
    fail('NUM_BOUNDARY_1632_38_>: replace with real assertion');
}
