...
# Source:  # nameserver we record -- both runs of the same domain always agree.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  (my $ns_host = lc $first->nsdname) =~ s/\.$//;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  $info{whois_raw} = substr($domain_whois, 0, $WHOIS_RAW_MAX);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  qr/Registration Time:\s*(\S+)/i,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  qr/Expir(?:y|ation)(?: Date)?:\s*(\S+)/i,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_3706_2 (MEDIUM) line 3706 in _analyse_domain() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_3706_2 line 3706 in _analyse_domain()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 3706 in _analyse_domain() to detect the mutant
...
# Source:  # Check the CHI cache before hitting DNS
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  # Try A record first, then AAAA for IPv6
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  my $query = $res->search($host, $type);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  $_cache->set("resolve:$host", $ip // '');
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  my $query = $res->search($ip, 'PTR');
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  # Check CHI cache before going to the network
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  my $result = $HAS_LWP ? $self->_rdap_lookup($ip) : {};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition unless to if
TODO: {
...
# Source:  # Fall back to raw WHOIS if RDAP returned no organisation
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Cache the enrichment result
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  my $iana = $self->_raw_whois($domain, 'whois.iana.org') // return;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  agent   => "Email-Abuse-Investigator/$VERSION",
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  $self->_debug("WHOIS read failed: $@") if $@;
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip <= to <
#   Numeric boundary flip <= to >
...
# Source:  qr/^OrgName:\s*(.+)/mi,    qr/^org-name:\s*(.+)/mi,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  qr/OrgAbuseEmail:\s*(\S+@\S+)/mi,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_4073_2 (MEDIUM) line 4073 in _parse_whois_text() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4073_2 line 4073 in _parse_whois_text()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4073 in _parse_whois_text() to detect the mutant
...
# Source:  # Prefer the first domain that matches the provider table (identifies ESP).
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Check if any signing domain matches a known provider
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_4164_2 (MEDIUM) line 4164 in _provider_abuse_for_host() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4164_2 line 4164 in _provider_abuse_for_host()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4164 in _provider_abuse_for_host() to detect the mutant
    fail('BOOL_NEGATE_4164_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_4195_2 (MEDIUM) line 4195 in _registrable() ---
# Source:  return unless $host && $host =~ /\./;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_4309_2 (MEDIUM) line 4309 in _enrich_ip() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4309_2 line 4309 in _enrich_ip()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4309 in _enrich_ip() to detect the mutant
    fail('BOOL_NEGATE_4309_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_4329_3 (MEDIUM) line 4329 in _header_value() ---
# Source:  sub _header_value :Private {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_4349_2 (MEDIUM) line 4349 in _header_value() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4349_2 line 4349 in _header_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4349 in _header_value() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_4374_2 (MEDIUM) line 4374 in _ip_in_cidr() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_4374_2 line 4374 in _ip_in_cidr()';
    # NOTE: new() called with no arguments as a starting point.
    # If Email::Abuse::Investigator requires constructor arguments, add them here.
    my $obj = new_ok('Email::Abuse::Investigator');
    # TODO: exercise line 4374 in _ip_in_cidr() to detect the mutant
...
# --- LOW HINT: RETURN_UNDEF_3706_2 line 3706 in _analyse_domain() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_4073_2 line 4073 in _parse_whois_text() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_4164_2 line 4164 in _provider_abuse_for_host() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_4309_2 line 4309 in _enrich_ip() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_4349_2 line 4349 in _header_value() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_4374_2 line 4374 in _ip_in_cidr() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
